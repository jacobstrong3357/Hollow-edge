...
- At least two full chase structures and the doorstep/threshold system have moved into the reducer.
...
- a two- or three-step chase distance state;
- doorstep events that remember whether the monster learned the player's home;
